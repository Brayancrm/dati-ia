    ...
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-56 bg-white border rounded shadow-lg z-50">
          ...
          {isMaster && <>
            <button className="block w-full text-left px-4 py-2 hover:bg-yellow-50 text-gray-900 font-medium" onClick={() => {router.push("/usuarios"); setOpen(false);}}>Usuários</button>
            <button className="block w-full text-left px-4 py-2 hover:bg-yellow-50 text-gray-900 font-medium" onClick={() => {router.push("/bases"); setOpen(false);}}>Gerenciar Bases</button>
